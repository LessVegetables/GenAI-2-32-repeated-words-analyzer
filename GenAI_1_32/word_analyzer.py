...
def process_text(filename, language):
    """
    Обрабатывает текст из файла: читает, токенизирует, лемматизирует и возвращает словарь из пар bigram / occurance-count
...
def process_text_and_plot(filename, language):
    """
    ...
    fdist = process_text(filename, language)
...
def main():
    ...
    process_text_and_plot(filename, language)
